...
Seuraavaksi määritellään tarkemmin nimiöiden sijoittelu. Mene Sijoittaminen-välilehdelle. Aseta tilaksi jälleen “Seuraa viivaa”, jolloin nimiö pysyy viivan mukana myös kaarroksissa. Jos haluat nimiöt teiden sisälle, aseta “Sallitut asemmoinnit” -kohtaan täppä “Viivalla”. Ota muut valinnat pois, jolloin QGIS sijoittaa nimiöt vain ja ainoastaan viivalle. Jos valitset tässä useamman vaihtoehdon, QGIS sijoittaa nimiön mihin tahansa niistä sen mukaan, mihin nimiö mahtuu.
...
Jos fontti ei meinaa erottua taustasta, yksinkertainen kikka on käyttää valkoista väriä fontille ja luoda sille musta tekstivyöhyke. Palaa siis ensimmäiselle välilehdelle. Valitse fontin väriksi valkoinen (#ffffff) ja siirry sitten Vyöhyke-välilehdelle. Laita raksi kohtaan “Piirrä tekstivyöhyke”. Oletuksena vyöhykkeen väri on valkoinen, mutta vaihda se mustaksi. Tämän jälkeen voit muuttaa vyöhykkeen kokoa niin, että siitä tulee siisti reunaviiva fontille.
...
::: hint-box
Vinkki!
QGISin oletusjärjestys sijoittelulle on ylös oikealle, ylös vasemmalle, alas oikealle, alas vasemmalle, keskelle oikealle, keskelle vasemmalle, ylös hieman oikealle ja ylös hieman vasemmalle. Tätä voidaan muokata lausekkeella kohdasta Position Priority > Muokkaa. Ohessa myös esimerkkilauseke. Ohjeet lausekkeiden muodostamiseen löydät lausekeikkunan vasemmasta alalaidasta.
:::
...
Korosta kiinnitetyt kohteet, Näytä sijoittamattomat (näkymättömät) nimiöinnit, Kiinnitä/poista kiinnitys, Näytä/poista näkyvistä nimiöinti, Siirrä nimiöintiä, Kierrä nimiöintiä, Muokkaa nimiöinniin ominaisuuksia.
...
Koita saada kaikkien kohteiden nimiöt näkyviin määrittämällä niille käsin jokin paikka. Kysy tarvittaessa kurssin pitäjältä lisätietoa työkalujen toimintaperiaatteista, tai pidä hiirtä hetki työkalun päällä, jolloin sen ohjeet tulevat näkyviin.
