...
Avaa **Tietolähteiden hallinta -> Vektori -> Etsi lataamasi Kartat_ja_taitot.gpkg** ja Lisää. Valitse kaikki tasot ja paina vielä **Lisää**.

![](img/harjoitus1/img1.png)


Aineisto sisältää piste- viiva- ja polygonikohteita, Voit tutkia minkälaisia tasoja GeoPackagessa on. Helpottaaksemme käsittelyä voimme jakaa kunkin aineistotyypin eri kansioihin. Luo piste-, viiva- ja polygonikohteille omat kansionsa painamalla ![](img/harjoitus1/img2.png) Tasot-paneelin yläreunasta. Nimeä tasoryhmä lisäämisvaiheessa kun se on aktiivinen, tai klikkaamalla tasoryhmää tasoluettelossa hiiren oikealla ja valitsemalla “Nimeä ryhmä”. Kun olet luonut kolme uutta kansiota, raahaa pistekohteet omaan kansioonsa, polygonit omaansa ja viivat omaansa. Näin saadaan aineisto järkevästi järjesteltyä. Jos kaikki kohteet eivät näy kunnolla, vaihda tasojen paikkaa raahaamalla esimerkiksi pistetasot polygonien yläpuolelle. QGIS visualisoi kohteet sen mukaan, miten ne ovat tasoluettelossa, eli ylimpänä olevat tasot ovat päällimmäisenä.
...
Täältä saat muokattua tarkemmin polygonin väriä ja täyttötyyppiä sekä ulkoviivan väriä ja ominaisuuksia. Värivalintaa painamalla saat laitettua myös valmiin HTML-koodin valitsimeksi. 
Vaihda tason täyttöväri ja viivan väri itsellesi mieluisiksi.
...
Viivakohteet voivat olla päällekkäisiä tasoja muiden tyyppisten tasojen päällä. Aineistossa tiet ja rakennuksen menevät usein päällekkäin eivätkä toimi kaikilla mittakaavatasoilla sujuvasti yhteen. Tehdään siis ensiksi rakennus-polygonitasolle siis **sääntöpohjainen visualisointi**.
...
::: hint-box
Tässä harjoituksessa käytetyt kohdeluokat perustuvat Maanmittauslaitoksen luokitukseen
Autotie Ia (12111), Autotie Ib (12112), Autotie IIa (12121), Autotie IIb (12122), Autotie IIIa (12131), Autotie IIIb (12132), Ajotie (12141).
Tarkemmat tiedot aineistosta löytyvät: https://www.maanmittauslaitos.fi/sites/maanmittauslaitos.fi/files/attachments/2023/06/Maastotietokohteet_2023_05.pdf
:::

Jotta saamme luotua mittakaavaperusteisen näkyvyyden aineistolle ja tehtyä eri luokille omat visualisointinsa, valitse tieviiva-aineistolle sääntöpohjainen visualisointi. Tee uusi sääntö paneelin vasemmasta alareunasta ![](img/harjoitus1/img9.png) -painikkeesta. Tästä tulee **luokka 1**.
...
Valitse aineistolle ensin yksi yksinkertainen täyttö, jossa on haluamasi väri. Sen jälkeen paina ![](img/harjoitus1/img9.png) -painiketta ja lisää toiseksi väriksi musta. 

![](img/harjoitus1/img10.png)

Jotta saat mustan värin reunaviivaksi ja valitsemasi värin pysymään tien päävärinä, aseta musta väri pohjimmaiseksi painamalla ![](img/harjoitus1/img11.png) -painiketta ja asettamalla mustan viivan paksuus täyttöväriä isommaksi. 
...
**Luokka 2**
"kohdeluokka" =12121 OR  "kohdeluokka" =12122
...
**Luokka 3**
"kohdeluokka"  = 12131 OR  "kohdeluokka" = 12132
...
Nyt reunaviivat on saatu piiloon. Seuraavaksi vielä asetetaan teiden keskinäinen piirtojärjestys niin, että päätiet piirtyvät pikkuteiden päälle. Klikkaa “Tason piirto” -kohtaa ja laita täppä “Säädä kohteiden piirtojärjestystä” -kohtaan. Tämän jälkeen paina sen vieressä olevaa symbolia avataksesi lisäasetukset.

![](img/harjoitus1/img14.png)
![](img/harjoitus1/img15.png)
...
Palaa polygonitasoihin ja valitse suot-taso. Luo tasolle toinen visualisointitaso painamalla ![](img/harjoitus1/img9.png).

Tee alemmasta tasosta hieman läpinäkyvä säätämällä sen täyttövärin peittävyyttä väriasetuksista 55 prosenttiin.

täyttöväri:: #0f7c79
täyttövärin läpinäkyvyys 55%
reunaviiva: #000000
